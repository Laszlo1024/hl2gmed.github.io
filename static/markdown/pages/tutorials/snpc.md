#  Introduction
NPC is what the AI in Half-Life 2 and Portal use.
...
First create the npc_ folder for your npc. The one I made for this tutorial is in "addons/Npc_tut/lua/npcs" and is named "npc_simple_ai", and has init.lua file inside.
